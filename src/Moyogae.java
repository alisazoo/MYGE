...
//    } // end for constructor MYGEwithGUI.Moyogae()
//
//    /**
...
//        label.add( new JLabel("MYGEwithGUI.Floor Width (mm)", SwingConstants.RIGHT) );
//        label.add( new JLabel("MYGEwithGUI.Floor Length (mm)", SwingConstants.RIGHT) );
...
//                "Set MYGEwithGUI.Floor Size", JOptionPane.QUESTION_MESSAGE);
//
