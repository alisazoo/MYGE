 ...
 * the paintComponent() method is called, new random values are used.
 * This means that a different picture will be drawn each time.
 */

public class RandomStringsPanel extends JPanel {
    private String message; // The message to be displayed. This can be set in the constructor.
                            // If no value is provided in the constructor, then "Java!" is used.
    ...
    public void paintComponent(Graphics g){
        super.paintComponent(g);    // Call the paintComponent method from the superclass, JPanel.
                                    // This simply fills the entire panel with the background color, black.
        ...
        for (int i = 0; i < 25; i++){
            // Draw one string. First, set the font to be one of the five available fonts, at random.
            ...
            // Set the colour to a bright, saturated colour, with random hue.
    ...
    // code from the textbook end.

    // display the content by the code above
    public static void main(String[] args) {
        JFrame window = new JFrame("Random Strings Panel");

        RandomStringsPanel content = new RandomStringsPanel("Hello");
